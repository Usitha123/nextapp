...
const FoodDisplay = ({ onAddToCart }) => {
  ...
  const [isLunchfastTime, setIsLunchfastTime] = useState(false);
  ...
  const filteredMeals = meals.filter(
    (meal) =>
      meal.mealType === "Lunch" && meal.selectCanteen === currentCanteen
  );
          ...
          <div className="p-4 grid grid-cols-[auto_40px]">
            ...
            <div className="relative">
              <button
                ...
                disabled={!isLunchfastTime || meal.mealstatus === "Inactive"}
