...
const Deletecashier = ({ isOpen, onClose, cashier, onDelete }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm">
      <div className="p-6 text-gray-300 bg-black rounded-lg shadow-lg w-80">
        ...
        <div className="flex justify-around gap-3 mt-6">
          <button
            ...
            type="button"
            className="px-6 py-2 text-sm font-medium text-black bg-orange-500 rounded-xl hover:bg-orange-600"
          >
            Yes
          </button>
          <button
